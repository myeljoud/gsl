      ...
      <section id="home" className="mx-auto w-full max-w-screen-laptop tablet:px-4 py-8 tablet:py-16  relative overflow-hidden tablet:overflow-visible ">
        ...
        <div className="grid grid-cols-1 tablet:grid-cols-2 gap-4 relative z-20">
          ...
          <div className="order-1 aspect-[2/1] tablet:aspect-[16/9] tablet:order-2 rounded-l-lg overflow-hidden ml-4 tablet:ml-0">
            <img src={heroSection.images[0].asset.url} alt="Vehicle" className="w-full h-full object-cover" />
          </div>
          ...
          <div className="hidden rounded-l-lg aspect-[2/1] tablet:aspect-[5/3]  tablet:block tablet:w-full  tablet:rounded-lg tablet:order-3 mr-4 tablet:mr-0">
            <img src={heroSection.images[1].asset.url} alt="Vehicles" className="hidden  object-cover tablet:block tablet:size-full tablet:rounded-lg tablet:order-3" />
          </div>
          <div className="aspect-[2/1] tablet:aspect-[5/3] rounded-r-lg tablet:rounded-lg overflow-hidden order-4 mr-4 tablet:mr-0 ">
            <img src={heroSection.images[2].asset.url} alt="Vehicles" className="size-full object-cover" />
          </div>
        </div>
      </section>
